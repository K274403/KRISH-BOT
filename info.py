...
# Bot Admins
ADMINS = environ.get('ADMINS', '1798348973') #apni tg id daalo
if len(ADMINS) == 0:
...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("-") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1002087964739 -1002160766163').split()]
if len(INDEX_CHANNELS) == 0:
    print('Info - INDEX_CHANNELS is empty')
AUTH_CHANNEL = [int(auth_channels) for auth_channels in environ.get('AUTH_CHANNEL', '-1002023191399').split()]
if len(AUTH_CHANNEL) == 0:
    print('Info - AUTH_CHANNEL is empty')
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1002186335716') #bot log channel -1005293546253
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1001779982100') #support group id ex:  -1002936246860
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://Lootere:Lootere@lootere.xlo7d.mongodb.net/?retryWrites=true&w=majority&appName=Lootere") #mongo db url
...
# Links
SUPPORT_LINK = environ.get('SUPPORT_LINK', 'https://t.me/+uw9bGEgcOzo1MDk1')
UPDATES_LINK = environ.get('UPDATES_LINK', 'https://t.me/rkmovieszip')
FILMS_LINK = environ.get('FILMS_LINK', 'https://t.me/cinemaa_time')
...
URL = environ.get("URL", "https://t.me/+XuIY_9AfhH4zOWJl") #if heroku then paste the app link here ex: https://heroku......./
if len(URL) == 0:
